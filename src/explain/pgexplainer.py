...
class PGExplainer(nn.Module):
    ...
    def train_step(self, graph, node_feat, edge_feat, tmp, **kwargs):
    ...
    def explain_graph(self, graph, node_feat, edge_feat, tmp=1.0, training=False, **kwargs):
        ...
        embed = self.model(graph, node_feat, edge_feat, embed=True, **kwargs)
        embed = embed.data
        ...
        edge_wfeat = edge_feat * self.edge_mask[:, None]
        logits = self.model(graph, node_feat, edge_wfeat, **kwargs)
