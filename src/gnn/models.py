...
class RGCNLayer(nn.Module):
    def __init__(
        self, in_feats, out_feats, num_rels=65, activation=F.relu, self_loop=False, dropout=0.5
    ):
...
class RGCN(nn.Module):
    def __init__(
        self, node_size, hidden_size, gnn_layers=3, fc_layers=3, rgcn_dropout=0.25, fc_dropout=0.25
    ):
